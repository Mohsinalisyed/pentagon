    ...
    <div className="flex flex-col lg:flex-row justify-between items-center px-0  xl:px-6 bg-zinc-900 text-white">
      ...
      >
        <Link
          ...
          className={`py-2 px-4 block lg:inline-block hover:bg-coreHoverColor hover:rounded w-full whitespace-nowrap border-b-2 border-borderColor lg:border-b-0 ${
            selectedLink === "ABOUT BCSH" ? "border-l-4 border-indigo-500 lg:border-l-0" : ""
        ...
        <Link
          ...
          className={`py-2 px-4 whitespace-nowrap block lg:inline-block hover:bg-purple-700 disabled border-b-2 border-borderColor lg:border-b-0 ${
            selectedLink === "HODLER PERKS" ? "border-l-4 border-indigo-500 lg:border-l-0" : ""
          } text-sm lg:text-base xl:text-lg`}
        >
          HODLER PERKS
        </Link>
        <Link
          ...
          className={`py-2 px-4 block lg:inline-block hover:bg-coreHoverColor hover:rounded w-full border-b-2 border-borderColor lg:border-b-0 ${
            selectedLink === "ROADMAP" ? "border-l-4 border-indigo-500 lg:border-l-0" : ""
          } text-sm lg:text-base xl:text-lg`}
        >
          ROADMAP
        </Link>
        <Link
          ...
          className={`py-2 px-4 block lg:inline-block hover:bg-purple-700 disabled border-b-2 border-borderColor lg:border-b-0 ${
            selectedLink === "AIRDROP" ? "border-l-4 border-indigo-500 lg:border-l-0" : ""
          } text-sm lg:text-base xl:text-lg`}
        >
          AIRDROP
        </Link>
        <Link
          ...
          className={`py-2 px-4 block lg:inline-block hover:bg-purple-700 disabled border-b-2 border-borderColor lg:border-b-0 ${
            selectedLink === "SOCIALS" ? "border-l-4 border-indigo-500 lg:border-l-0" : ""
          } text-sm lg:text-base xl:text-lg`}
        >
          SOCIALS
        </Link>
